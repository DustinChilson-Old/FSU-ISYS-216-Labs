...
public class StudentGrades extends JFrame 
{
   ...
   private void createUserInterface()
   {
      ...
      inputGradeJPanel.setBorder( new TitledBorder( "Input Grade" ));
   ...
   private void displayLetterGrades()
   {
      ...
      Integer studentTotal = 0; // store the student's total grades
      Integer classTotal = 0;   // store the class's total grades
      ...
      for ( int student = 0; student < studentCount; student++ )
      {
         ...
         {
            // append each test grade to displayJTextArea
            displayJTextArea.append( convertToLetterGrade(studentGrades[ student ][ test ] ) + "\t" );
